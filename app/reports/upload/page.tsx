...
const REPORT_TYPES = [
  { code: "OEA07V", label: "OEA07V — Daily Sales Activity (CSV)", description: "Daily item-level sales/returns — fuels WTD Commission and Dunlop reports", accept: ".csv,.xlsx" },
  ...
  { code: "oeival", label: "OEIVAL — Inventory Snapshot (XLSX)", description: "Inventory quantities, costs, pricing by warehouse", accept: ".xlsx" },
  { code: "oea07v-sales", label: "OEA07V — Monthly Sales History (XLSX)", description: "Monthly sales totals by item with stock levels", accept: ".xlsx", needsWarehouse: true },
  { code: "tires", label: "Tires Catalog (CSV)", description: "Product catalog with tire specs (~50K rows)", accept: ".csv" },
];
