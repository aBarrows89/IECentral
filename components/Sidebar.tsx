...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/reports/sales", label: "Sales Dashboard", icon: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
          ...
          {filteredNavGroups.map((group) => {
            ...
            const filteredItems = group.items.filter((item) => {
              ...
              const routePerms: Record<string, boolean> = {
                ...
                "/reports/sales": permissions.menu.reports,
